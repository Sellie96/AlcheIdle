...
exports.FiremakingService = void 0;
const common_1 = require("@nestjs/common");
const users_service_1 = require("../../../user/users.service");
let FiremakingService = class FiremakingService {
    constructor(usersService) {
        this.usersService = usersService;
        this.firemakingUsers = [];
        this.timeLeft = 10;
        this.clientToUser = {};
    }
    addToFiremakingActive(activeLog) {
...
FiremakingService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [users_service_1.UsersService])
], FiremakingService);
exports.FiremakingService = FiremakingService;
//# sourceMappingURL=firemaking.service.js.map