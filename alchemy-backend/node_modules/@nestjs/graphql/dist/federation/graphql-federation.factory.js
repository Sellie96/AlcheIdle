...
let GraphQLFederationFactory = class GraphQLFederationFactory {
    constructor(resolversExplorerService, scalarsExplorerService, gqlSchemaBuilder, gqlSchemaHost, typeDefsDecoratorFactory) {
    ...
    async buildFederatedSchema(autoSchemaFile, options, resolvers) {
        ...
        try {
            ...
            if (buildSchemaOptions === null || buildSchemaOptions === void 0 ? void 0 : buildSchemaOptions.directives) {
    ...
    getFederationVersionAndConfig(autoSchemaFile) {
        ...
        if (typeof autoSchemaFile.federation !== 'object') {
            return [(_a = autoSchemaFile.federation) !== null && _a !== void 0 ? _a : DEFAULT_FEDERATION_VERSION];
        }
        return [
            (_c = (_b = autoSchemaFile.federation) === null || _b === void 0 ? void 0 : _b.version) !== null && _c !== void 0 ? _c : DEFAULT_FEDERATION_VERSION,
